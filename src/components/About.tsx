      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className={`space-y-8 text-lg md:text-xl leading-relaxed ${
            ...
            >
              I'm <span className={`font-semibold ${isDark ? 'text-white' : 'text-black'}`}>Akhil Vishnubhotla</span> — doing my best to stay one step ahead of the AI before it replaces me entirely.
            </motion.p>
            ...
            >
              I study <span className={`font-medium ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Computer Science and AI</span> at the University of Alberta, and I'm passionate about building software that's actually useful — innovative, purposeful, and a little ahead of the curve.
            </motion.p>
          </div>
            ...
            >
              <motion.div
                className={`absolute inset-0 ${
                  isDark ? 'bg-gradient-to-r from-gray-200 to-white' : 'bg-gradient-to-r from-gray-700 to-black'
                }`}
                initial={{ x: '-100%' }}
                whileHover={{ x: '100%' }}
